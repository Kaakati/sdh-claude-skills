---
name: std-i18n
description: Internationalization standards — locale files, key naming, pluralization, RTL, CSS logical properties across Rails/RN/Vite/Next. Use when adding user-facing strings or locales.
paths:
  - "**/config/locales/**"
  - "**/i18n/**"
  - "**/locales/**"
