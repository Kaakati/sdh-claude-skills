---
name: std-git-workflow
description: Git workflow standards — Conventional Commits, branch naming, PR requirements, squash/rebase, protected branches. Apply when committing, branching, or opening PRs.
---
