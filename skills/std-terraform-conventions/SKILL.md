---
name: std-terraform-conventions
description: Terraform HCL conventions — file structure, provider version constraints, resource naming, required tags, security minimums, state/backend. Use when writing Terraform.
paths:
  - "**/*.tf"
  - "**/*.tfvars"
---
